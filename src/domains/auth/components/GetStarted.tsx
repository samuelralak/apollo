...
import {SignerMethod, signIn} from "../store/auth.slice";
                        ...
                        <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <XMarkIcon onClick={() => setShowModal(false)} className="h-5 w-5 cursor-pointer text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200"/>
                                </DialogTitle>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center">
                                        <span
                                            className="bg-white dark:bg-slate-800 px-2 text-sm text-slate-500 dark:text-slate-400 font-medium">or</span>
                                    </div>
                                </div>
                                ...
                                <div className="mt-1">
                                    ...
                                    <div
                                        className="rounded-lg bg-yellow-50 dark:bg-yellow-900/30 py-3 px-1.5 my-3 border-2 border-yellow-100 dark:border-yellow-800">
                                        <div className="flex">
                                            <div className="flex-shrink-0">
