        ...
        <>
            ...
            <div className="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
                ...
                <Menu as="div" className="relative ml-3">
                    ...
                    <MenuItems
                        transition
                        className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transition ease-out duration-200 data-[closed]:opacity-0 data-[closed]:scale-95">
                        <MenuItem>
                            {({focus}) => (
                                <Link
                                    to={`/user/${auth.pubkey}`}
