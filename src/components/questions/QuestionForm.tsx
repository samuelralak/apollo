import SelectMenu from "../forms/SelectMenu.tsx";
...
const QuestionForm = ({question}: { question?: Question }) => {
    ...
    const {
        ...
        resolver: zodResolver(questionSchema), defaultValues: {
                ...
                <div className="sm:col-span-4">
                    ...
                    <div className="mt-5 w-full">
                        <SelectMenu
                            ...
                            defaultValue={question?.category ? options.filter((o) => o.slug === question?.category)[0] : undefined}
