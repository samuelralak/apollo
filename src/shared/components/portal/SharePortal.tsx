        ...
        <Dialog open={visible} onClose={handleHidePortal} className="relative z-10">
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div
                    ...
                    <DialogPanel
                        transition
                        className="relative transform overflow-hidden rounded-xl bg-white dark:bg-slate-800 px-4 pb-4 pt-5 text-left shadow-xl ring-1 ring-slate-200 dark:ring-slate-700 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] my-8 w-full sm:max-w-xl sm:p-6 data-closed:opacity-0 data-closed:scale-95 data-closed:-translate-y-4"
                    >
                        <DialogTitle as="h2"
